...
we can make without any information about a patient. It is simply the
...
the compatibility between the data and the null hypothesis assuming
all assumptions about the null hypothesis are correct (Greenland et al).
...
Caption: Figure 5. Power simulations comparing statistical power for linear Cox regression and
